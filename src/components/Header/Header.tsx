...
export const Header: React.FC = () => {
    ...
    return (
        <>
            <header style={{ ...headerStyle, fontSize: fontSize === 'small' ? '12px' : fontSize === 'medium' ? '16px' : '20px' }}>
                <h1 className='font-semibold pl-4'>The Hong Kong Council for Testing and Certification</h1>
                <div className='flex flex-row gap-4 items-center pr-4'>
                    <Icon icon="ri:search-line" className='h-6 w-6 text-[#333333]' />
                    <img src="/icons/font.svg" alt="Font Icon" className='h-5 w-5 text-[#333333]' />
                    <Icon icon="ci:globe" className='h-6 w-6 text-[#333333]' />
                    <div style={{ width: '1.5px', height: '18px', backgroundColor: '#666666' }}></div>
                    <Icon icon="mage:camera-2" className='h-6 w-6 text-[#333333]' />
                    <Icon icon="fa6-brands:facebook-f" className='h-5 w-5 text-[#333333]' />
                </div>
            </header>
        </>
    );
