      ...
      <div style={maxPCContainer}>
        ...
        <div className="w-full flex flex-row pt-[48px] pr-[24px]">
          ...
          <div className="flex-1">
            ...
            <p className="text-body-m">
              Electrical and electronic products (EEPs) are widely used in
              almost all aspects of daily life including audio and video
              equipment, children's toys, communication devices, household
              appliances and lighting products. EEPs are also invaluable for
              essential medical and public utilities. Safety and performance of
              EEPs are thus of paramount concern. It is vital that all EEPs sold
              meet stringent and performance standards to ensure they are safe
              and suitable for their intended use.
              <br />
              <br />
              The EEP industry uses numerous third-party testing and
              certification services to ensure products comply with
              international/national standards or regulations specified by
              importing countries. Through testing and certification, the
              quality of EEPs can be enhanced. This helps manufacturers and
              traders to minimise the chance of recalls, returns and complaints,
              and to establish a good reputation as well as to enhance product
              sales.
            </p>
            <hr className="my-[24px]" />

            <p className="text-heading-l">
              EEP Testing & Certification Services
            </p>
            <p className="text-body-m my-[24px]">
              Accredited testing and certification organisations in Hong Kong
              can provide professional services in electrical and electronic
              product (EEP) testing, inspection and certification at different
              stages throughout the product supply chain.
            </p>
