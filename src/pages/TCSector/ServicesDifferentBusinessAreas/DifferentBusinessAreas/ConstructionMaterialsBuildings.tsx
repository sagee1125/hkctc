...
const multilingual = {
  en: {
    ...
    benefits_of: "Benefits of Product Certification for Construction Materials",
    ...
    use_of_prod_HA_detail: (
      <>
        ...
        construction products in their building projects. A number of suppliers
    ...
    use_of_prod_BEAM_detail_1: (
      <>
        ...
        Plus offers a comprehensive set of performance criteria for a wide range
        of sustainability issues relating to the planning, design, construction,
        commissioning, management, operation and maintenance of a building. By
        providing a fair and objective assessment of a building's overall
        performance throughout its life cycle, BEAM Plus enables organisations
        and companies of all sizes to demonstrate their commitment to
    ...
    use_of_prod_BEAM_detail_2: (
      <>
        ...
        construction and commissioning of a new building project. It can also be
        applied to major renovations, alterations and additions. Under the
    ...
    use_of_prod_ASD_detail_1: (
      <>
        ...
        present the mechanism of product certification and the benefits of using
        certified construction products in construction works. Examples have
