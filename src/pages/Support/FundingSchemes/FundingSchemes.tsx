      ...
      PASS: {
        ...
        the_pass_launched_by: (
          <p className="text-body-m mb-[16px]">
            ...
            increasing the exchanges and co-operation of Hong Kong's
            professional services with their counterparts in external markets,
            promoting relevant publicity activities, and enhancing the standards
            and external competitiveness of professional services in Hong Kong.
          </p>
        ),
            ...
            <a
              ...
              href={
                language === Language.ZH_TW
                  ? "https://www.pass.gov.hk/index_tc.html"
                  : "https://www.pass.gov.hk/index_sc.html"
              }
              target="_blank"
              rel="noopener noreferrer"
              className="underline text-[#00E]"
