    ...
    specificCommitments: [
      ...
      <>
        <p>
          ...
          jointly or solely set up in the Mainland by Hong Kong service
          suppliers, when participating in testing and certification activities,
          the same treatment as is accorded to Mainland certification bodies,
      ...
      <p>
        ...
        suppliers, in the mode of movement of natural persons, to provide
        services under this industry or sub-industry in the Mainland.&nbsp;
        <a
...
export const SupplementXtoCEPAClauses: React.FC = () => {
  ...
  return (
    <div className="flex-1">
      ...
      >
        {page_text.specificCommitments.map((commit, index) => (
          <div key={index}>
            <br />
            <li>{commit}</li>
          </div>
      ...
      <p className="text-heading-m mb-[24px]">
        {page_text.Trade_and_Investment}
      </p>
      <p className="text-body-m  text-justify">
        {page_text.two_sides_agreed}
        <br />
        <br />
        {page_text.promote_Guangdong}

        <br />
        <br />
        {page_text.accordance_with_specific}

        <br />
        <br />
        {page_text.with_regard_to}
      </p>
      <hr className="my-[24px]" />
      <InternalBackButton
