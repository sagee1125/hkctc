      ...
      <div className="w-full flex flex-row pt-[48px] pr-[24px]">
        ...
        <div className="flex-1">
          ...
          <p className="text-body-m my-[24px]">
            ...
            allowed to co-operate with designated Mainland certification bodies
            to undertake testing of all products that require CCC which are
            ...
            under the CCC System have to be accredited by Hong Kong
            Accreditation Service (HKAS) to be capable of performing testing for
            the relevant products. Procedures for testing organisations in
