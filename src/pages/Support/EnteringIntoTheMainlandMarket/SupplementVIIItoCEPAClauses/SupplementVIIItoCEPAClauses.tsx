      ...
      <div style={maxContainer}>
        ...
        <div className="w-full flex flex-row pt-[48px] pr-[24px]">
          ...
          <div className="flex-1">
            ...
            <p className="text-body-m">
              To expand, on the basis of Supplement VII to the CEPA, the scope
              of product testing that can be undertaken by testing organizations
              in Hong Kong for the China Compulsory Certification (CCC) System
              to all existing products processed in Hong Kong that require CCC.
              These testing organizations have to be accredited by the
              accreditation body of the Government of Hong Kong Special
