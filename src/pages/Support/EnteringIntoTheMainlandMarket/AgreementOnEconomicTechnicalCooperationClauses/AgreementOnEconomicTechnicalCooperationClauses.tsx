        ...
        <div className="w-full flex flex-row pt-[48px] pr-[24px]">
          ...
          <div className="flex-1">
            ...
            <p className="text-body-m">
              ...
              cooperation channels to strengthen cooperation in the innovation
              of certification and accreditation systems, and support the
            ...
            <p className="text-body-m">
              ...
              certification bodies under the China Compulsory Certification
              (CCC) System.
            </p>
            <hr className="my-[24px]" />
            <InternalBackButton
