      ...
      <div className="w-full flex flex-row pt-[48px] pr-[24px]">
        ...
        <div className="flex-1">
          ...
          <p className="text-body-m">
            ...
            in Hong Kong). These testing organizations have to be accredited by
            the accreditation body of the Government of Hong Kong Special
            Administrative Region (i.e. the Hong Kong Accreditation Service) to
            be capable of performing testing for the relevant products under the
            CCC System. Cooperation arrangements should comply with relevant
            requirements in the "Regulations of the People's Republic of China
          ...
          <p className="text-body-m my-[24px]">
            ...
            and standardisation. Accordingly, the following subparagraphs 5.2.5
            and 5.2.6 are added to Article 5.2 of Annex 6 to "CEPA":
            <br />
            <br />
