      ...
      summary: {
        ...
        note: (
          <>
            ...
            :
            「工業大廈」指在地段合法興建的樓宇，而根據地契條件，該地段除作工業及／或倉庫用途外，不得作任何用途。這些地段在本文件中稱為工業地段。這類工業大廈不包括特殊的工廠大廈，例如貨櫃碼頭內的貨倉及香港房屋委員會興建的分層工廠大廈，以及特殊的工業，例如貨物裝卸、造船及修船、存油、煉油及生產相關化學副產品、製造聚苯乙烯塑料、製造及存儲氯氣、氫氣及紡織化工等所用的地段。
          </>
        ),
