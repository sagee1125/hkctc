        ...
        <div className="w-full h-full grid grid-cols-[1fr,2fr] pt-[48px] gap-[24px] px-[24px]">
          ...
          <div className="flex flex-col gap-[24px]">
            ...
            <p className="text-body-m">
              HKCTC launches the first “Testing and Certification Manpower
              Development Award Scheme” (the Award Scheme) in 2021 to recognise
              testing and certification (T&C) bodies which attach great
              importance to talent training and manpower development, as well as
              to encourage T&C practitioners to strive for improvement and
              ...
              details={
                <div>
                  ...
                  <p className="text-[#4B4746]">
                    ...
                    Commitment to Testing and Certification Practitioners’
            ...
            <div className="w-full flex flex-row gap-[16px]">
              ...
              <p className="text-body-m">
                ...
                December 2021 at the Hong Kong Convention and Exhibition Centre.
                The Secretary for Innovation and Technology, Mr Alfred Sit,
                kindly attended as the Guest of Honour. Apart from members of
                the HKCTC and its Manpower Development Panel, the event was also
                attended by the chairmen and members of the two assessment
                panels as well as representatives of the supporting
                organisations. They all shared the joy of awardees.
              </p>
            </div>
            ...
            <div className="w-full flex flex-row gap-[16px]">
              <div className="w-[32px] bg-[#333333]" />
              <p className="text-body-m">
                At the ceremony, 16 testing and certification (T&C)
                practitioners, comprising 6 junior professionals and 10 middle
                management personnel, were presented with the “Excellent Testing
                and Certification Professional Award”. Besides, 30 T&C
                organisations received the “Testing and Certification Manpower
                Development Corporate Award”, where two of them were given
                special commendation for their exceptional commitment to T&C
                practitioners’ training and development.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-[24px]">
              ...
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
                (From left) <br />
                Ms Rebecca Pun, Commissioner for Innovation and Technology, Mr
                Alfred Sit, Secretary for Innovation and Technology, and Prof.
                Albert Yu, HKCTC Chairman, attended the ceremony to share the
                joy of awardees.
              </p>
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
                Group photo of Members of HKCTC and Panel on Manpower
                Development and Officiating Guests
              </p>
              ...
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
                ...
                Professional Award”, Chairman and Members of Assessment Panel,
                and Officiating Guests
              </p>
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
              ...
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
                The Hong Kong Jockey Club – Racing Laboratory and UL
                International Limited were awarded the Special Commendation of
              ...
              <div />
              <p className="text-italic-s text-grey italic mt-[16px] mb-[20px]">
                Awardees of “Excellent Testing and Certification Professional
                Award” shared their experience and insights at the ceremony
              </p>
            </div>
            ...
            {applicationData.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex flex-row h-[90px] gap-[24px] w-full"
                >
