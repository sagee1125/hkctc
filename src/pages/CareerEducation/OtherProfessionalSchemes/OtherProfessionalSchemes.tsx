    ...
    <div className="w-full flex flex-row gap-[24px] pr-[24px]">
      <div className="flex-1">
        ...
        <p className="text-body-m mt-[24px]">
          There are other organisations which have developed various
          professional schemes to enhance professionalism and capability of
          testing and certification practitioners.
        </p>
