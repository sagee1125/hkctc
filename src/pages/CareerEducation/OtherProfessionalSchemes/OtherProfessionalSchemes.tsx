...
export const OtherProfessionalSchemes: React.FC = () => {
  ...
  const multilingual = {
    en: {
      ...
      materials_engineers: (
        <>
          Materials engineers offer necessary support to manufacturers,
          suppliers, construction companies and construction materials
          laboratories, etc. by ensuring quality and safety of construction
          materials and works. Applicants holding a materials-related
          engineering degree accredited/recognised by Hong Kong Institution of
          Engineers (HKIE) (or a degree in building, civil, chemical,
      ...
      currently: (
        <>
          ...
          <a
            ...
            href="https://www.hktic.org/en/PersonnelCertification"
            target="_blank"
            rel="noopener noreferrer"
            className="underline text-[#00E]"
          >
      ...
      bottom: (
        <>
          The Hong Kong Institution of Certified Auditors (HKICA) is operating
          the Certification Scheme for Quality Management System Auditor
          (CSQMSA) based on the ISO/IEC 17024:2012 "Conformity assessment –
          General requirements for bodies operating certification of persons".
          The scheme has been accredited by China National Accreditation Service
          ...
          its&nbsp;
          <a
            aria-label="Website of The Hong Kong Institution of Certified Auditors"
    ...
    cn: {
      ...
      materials_engineers: (
        <>
          ...
          <a
            aria-label="香港工程師學會網頁"
            href={
              language === Language.ZH_TW
                ? "https://www.hkie.org.hk/zh-hant/"
                : "https://www.hkie.org.hk/zh-hant/"
            }
            target="_blank"
            rel="noopener noreferrer"
      ...
      currently: (
        <>
          ...
          <a
            ...
            href={
              language === Language.ZH_TW
                ? "https://www.hktic.org/zh_HK/PersonnelCertification"
                : "https://www.hktic.org/zh_CN/PersonnelCertification"
            }
            target="_blank"
            rel="noopener noreferrer"
            className="underline text-[#00E]"
