    ...
    <div className="w-full flex flex-row gap-[24px] pr-[24px]">
      <div className="flex-1">
        ...
        <p className="text-body-m">
          ...
          the Specification of Competency Standards (SCS) for the sector and
        ...
        <p className="text-body-m">
          As a measure to recognise work experiences and competencies acquired
          by practitioners at the workplace, a Recognition of Prior Learning
          (RPL) mechanism under the QF provides an alternative route for
          practitioners to obtain QF-recognised qualifications without
          undergoing a training programme, thus facilitates their subsequent
          progression in learning, and probably in careers. It is particularly
          useful to practitioners who do not possess high academic attainment
          but have acquired substantial practical experience in industry.
          <br />
          <br />
          Based on the SCS formulated by the Testing, Inspection and
          Certification Industry, the RPL is conducted in the form of clusters
          of units. Applicants may decide on the level of qualification for the
          clusters they wish to apply for recognition based on their prior
          working experience and relevant experience.
        </p>
        <br />
        <p className="text-body-m">
          The School of Science and Technology of Open University of Hong Kong
          has been appointed by the Secretary for Education as the independent
