        ...
        programmes: [
          {
            ...
            tcUrl:
              "https://www.gs.cuhk.edu.hk/admissions/programme/science#msc-in-accreditation-chemistry",
            scUrl:
              "https://www.gs.cuhk.edu.hk/admissions/programme/science#msc-in-accreditation-chemistry",
          },
        ],
        ...
        programmes: [
          {
            ...
            tcUrl:
              "https://admissions.hkmu.edu.hk/tc/ug/st/integrated-testing-inspection-and-certification/",
            scUrl:
              "https://admissions.hkmu.edu.hk/sc/ug/st/integrated-testing-inspection-and-certification/",
          },
          {
          ...
          },
          {
            ...
            tcUrl:
              "https://admissions.hkmu.edu.hk/tc/ug/st/testing-science-and-certification/",
            scUrl:
              "https://admissions.hkmu.edu.hk/sc/ug/st/testing-science-and-certification/",
          },
        ],
      },
      {
        ...
        programmes: [
          {
            ...
            tcUrl:
              "https://thei.edu.hk/tc/departments/department-of-food-and-health-sciences/bachelor-of-science-honours-testing-and-certification/",
            scUrl:
              "https://thei.edu.hk/sc/departments/department-of-food-and-health-sciences/bachelor-of-science-honours-testing-and-certification/",
          },
        ],
      },
    ],
        ...
        programmes: [
          {
            ...
            tcUrl:
              "http://www.vtc.edu.hk/admission/tc/programme/as114103-higher-diploma-in-analytical-science/",
            scUrl:
              "https://www.vtc.edu.hk/admission/sc/programme/as114103-higher-diploma-in-analytical-science/",
          },
        ],
      },
    ],
    ...
    en: {
      ...
      intro: (
        <>
          ...
          etc. The tertiary education industry in Hong Kong has been offering
          more academic programmes dedicated to testing and certification,
          ranging from the sub-degree to postgraduate levels.
          <br />
          <br />
      ...
      VTC_detail: (
        <>
          ...
          <a
            ...
            href={
              language === Language.ZH_TW
                ? "https://www.vtc.edu.hk/studyat/tc/"
                : "https://www.vtc.edu.hk/studyat/sc/"
            }
            target="_blank"
            rel="noopener noreferrer"
            className="underline text-[#00E]"
      ...
      HKPC_detail: (
        <>
          ...
          <a
            ...
            href={
              language === Language.ZH_TW
                ? "https://www.hkpcacademy.org/"
                : "https://www.hkpcacademy.org/zh-hans/"
            }
            target="_blank"
            rel="noopener noreferrer"
            className="underline text-[#00E]"
