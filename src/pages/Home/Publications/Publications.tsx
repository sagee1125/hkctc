    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          nav: `/events-promotion?section=${navItemEnum.pamphlets_booklets}`,
        },
        {
          title: "Comics",
          titleCN: "漫畫",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          titleCN: "《服務貿易協議》",
          imgPath: "images/agreement_small.png",
          nav: `/support?section=${navItemEnum.entering_into_the_mainland_market}&scroll_id=agreement_on_trade_in_services#1`,
        },
        {
          title: "Agreement on Trade in Goods",
          titleCN: "《貨物貿易協議》",
          imgPath: "images/agreement_small.png",
          nav: `/support?section=${navItemEnum.entering_into_the_mainland_market}&scroll_id=agreement_on_trade_in_goods#1`,
        },
        {
          title: "Agreement on Economic and Technical Cooperation",
          titleCN: "《經濟技術合作協議》",
          imgPath: "images/agreement_small.png",
          nav: `/support?section=${navItemEnum.entering_into_the_mainland_market}&scroll_id=agreement_on_economic_and_technical_cooperation#1`,
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          nav: `/events-promotion?section=${navItemEnum.student_competition}&scroll_id=hk_youth_science`,
        },
      ],
      seeMore: `/events-promotion?section=${navItemEnum.award_scheme}`,
    },
